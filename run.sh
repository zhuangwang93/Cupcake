...
# horovodrun -np 4 python3 compress_benchmark.py --compress --compressor randomk --comm allgather --memory residual --fusion-num 2 --model=resnet50 --compress-ratio 0.01
# horovodrun -np 4 python3 compress_benchmark.py --compress --compressor topk --comm allgather --memory residual --fusion-num 2 --model=resnet50 --compress-ratio 0.01
horovodrun -np 4 python3 compress_benchmark.py --compress --compressor dgc --comm allgather --memory dgc --fusion-num 2 --model=resnet50 --compress-ratio 0.01