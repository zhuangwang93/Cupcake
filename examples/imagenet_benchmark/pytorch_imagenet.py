...
parser.add_argument('--train-dir', default=os.path.expanduser('imagewang/train'),
                    help='path to training data')
parser.add_argument('--val-dir', default=os.path.expanduser('imagewang/val'),
...
if __name__ == '__main__':
    ...
    if args.adam:
        optimizer = optim.Adam(model.parameters(), lr=args.base_lr * hvd.size())
    else:
